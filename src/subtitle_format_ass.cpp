...
struct Writer {
	...
	: file(filename, encoding)
	{
		...
		file.WriteLineToFile(std::string("; Script generated by TypeMotion PreBuild-v1.0.2"));
		file.WriteLineToFile("; https://github.com/SonizBeibe/TypeMotion");
	}
	...
	void Write(ProjectProperties const& properties) {
		file.WriteLineToFile("");
		file.WriteLineToFile("[TypeMotion Project Garbage]");
